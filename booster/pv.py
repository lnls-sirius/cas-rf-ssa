...
for heatsink_num in range(1, 7):
    ...
    for reading_item_num in range(1, 35):
        ...
        current_name = "Current2-Mon" if reading_item_num % 2 == 0  else "Current1-Mon"
        ...
        bar_pv_aux = "{0}:{1}-{2}-{3}{4:0>2}{5}{6:0>2}:{7}".format(
            SEC_SUB_KEY, DIS, DEV_CURRENT, BAR, heatsink_num,
            BAR_ITEM, m_name, current_name)
